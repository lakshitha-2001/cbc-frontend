      ...
      <h1 className="text-3xl font-bold mb-8">Your Shopping Cart</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-gray-600 mt-1">
                    {item.labelledPrice && item.labelledPrice > item.price ? (
                      <>
                        <span className="text-red-600 font-semibold">Rs.{item.price?.toFixed(2)}</span>
                        <span className="ml-2 text-sm line-through">Rs.{item.labelledPrice?.toFixed(2)}</span>
                      </>
                    ) : (
          ...
          <div className="bg-gray-50 p-6 rounded-lg h-fit sticky top-4">
            ...
            <button 
              className="w-full bg-black hover:bg-gray-800 text-white py-3 px-6 font-medium mt-6 transition"
