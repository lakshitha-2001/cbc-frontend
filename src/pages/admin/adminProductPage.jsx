            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {products.map((product, index) => {
                  const discount = calculateDiscount(product.price, product.labelledPrice)
                  return (
                    <tr
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold align-top">
                        {product.price ? (
                          <>
                            <span className={discount > 0 ? "text-red-600" : "text-gray-900"}>
                              ${product.price}
                            </span>
                            {discount > 0 && (
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 align-top">
                        {product.labelledPrice ? (
                          discount > 0 ? (
                            ...
                            <span>${product.labelledPrice}</span>
                          )
                        ) : (
                          <span className="text-gray-400">-</span>
                        )}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        {selectedProduct.price ? (
                          <>
                            <p className={
                              calculateDiscount(selectedProduct.price, selectedProduct.labelledPrice) > 0 
                            ...
                            {calculateDiscount(selectedProduct.price, selectedProduct.labelledPrice) > 0 && (
                              <p className="text-xs text-gray-500">
                                {calculateDiscount(selectedProduct.price, selectedProduct.labelledPrice)}% off
                              </p>
                            )}
                          </>
                        ) : (
                        ...
                        <p className="text-gray-900">
                          {selectedProduct.labelledPrice ? (
                            calculateDiscount(selectedProduct.price, selectedProduct.labelledPrice) > 0 ? (
                              ...
                              <span>${selectedProduct.labelledPrice}</span>
                            )
                          ) : (
                            <span className="text-gray-400">-</span>
                          )}
