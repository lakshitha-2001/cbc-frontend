...
export default function AdminHomePage() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900">
      {/* Mobile Menu Button */}
      ...
      <div className="flex flex-1">
        {/* Sidebar - Desktop */}
        <div className="hidden md:flex w-[280px] bg-gradient-to-b from-purple-900 via-purple-950 to-slate-900 flex-col shadow-2xl border-r border-purple-800/30">
          ...
          <div className="bg-white/5 backdrop-blur-sm border-b border-purple-800/30 px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center bg-white/10 rounded-full px-3 py-1.5 flex-1 max-w-md mx-4">
                ...
                <input
                  type="text"
                  placeholder="Search products, sliders, orders, or customers..."
...
// Keep all other components (SidebarContent, BeautyDashboard, CustomersPlaceholder, NotFoundPage) exactly the same as in your original code
    ...
    <>
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        ...
        <div className="pt-2 pb-2">
          <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider px-4 py-2">Content Management</p>
        </div>
        ...
        <Link
          className={`flex items-center py-3 px-4 rounded-xl transition-all duration-300 ${getActiveClass("sliders")}`}
          to="/admin/sliders"
          onClick={closeMobileMenu}
        >
